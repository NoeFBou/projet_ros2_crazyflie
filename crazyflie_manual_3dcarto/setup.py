...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/launch.3dcarto_setup.py', 'launch/simple_mapper_real.py', 'launch/simple_mapper_simulation.py']),
        ('share/' + package_name + '/config', ['config/rviz-sim-config.rviz', 'config/rviz-real-config.rviz', 'config/crazyflie_real_crazyswarm2.yaml']),
    ],
